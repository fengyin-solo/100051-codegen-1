...
ROUTERS = [router_section, router_signal, router_switch, router_track, router_interlock, router_atp, router_plan, router_task, router_fault, router_dispose, router_spare, router_measure, router_patrol, router_window, router_alarm, router_verify, router_shift, router_assess, router_training]
