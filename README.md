...
| 培训演练 | `training` | 培训排期与人员成绩 | 培训编号、岗位、设备类型、签到、考核成绩、结业状态 |
...
- 培训演练状态固定为：待开班 → 培训中 → 待考核 → 已结业；首次签到进入培训中，
  结束演练后才能录入成绩。成绩按人员逐条生效，空成绩提示补录而不是判合格，同一人员
  重复提交只保留首次成绩；结业名单仅包含培训已结业且本人合格的记录。
